# Google Cloud Memorystore for Redis API MCP Server

This MCP (Model Content Protocol) server provides access to Google Cloud Memorystore for Redis API API functionality through HTTP, HTTPS, and STDIO transport modes.
